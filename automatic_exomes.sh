...
####    It is best to set up a script   ####
####    to run the protocol on all      ####
####    samples.                        ####
####    For new users, it is good to    ####
####    make one script per file to     ####
####    see how each component works    ####
####    at first.                       ####
############################################

# If you start here with some randon fastq file names
# rename the sampel ID and path in this script
# /project_folder/
